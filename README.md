# Francis Soung's Blog 模板

### [我的博客在这里 &rarr;](http://francissoung.github.io)
...
我的博客仓库——`francissoung.github.io`,可以直接下载zip到本地自己去修改。

```
$ git clone https://github.com/FrancisSoung/francissoung.github.io.git
```

**[在这里预览模板 &rarr;](http://blog.francissoung.com)**

## 支持

* 你可以自由的fork。如果你能主题作者和 github 的地址保留在你的页面底部，我将非常感谢你。
* 如果你喜欢我的这个博客模板，请在`francissoung.github.io`这个repository点个赞——右上角**star**一下。
...
经 [@FrancisSoung](https://github.com/FrancisSoung)的测试，好像两个命令都是可以的自动运行修改后的文件的，刷新后可以实时预览。官方文件是建议安装bundler，这样你在本地的效果就跟在github上面是一样的。详情请见这里：https://help.github.com/articles/using-jekyll-with-pages/#installing-jekyll
...
```
# Site settings
title: Francis Soung Blog             # 你的博客网站标题
SEOTitle: Francis Soung Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: FrancisSoung     # 你的github账号
weibo_username: Franciskeke      # 你的微博账号，底部链接会自动更新的。
...
看右边:
![sidebar](http://www.francissoung.com/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-francis.jpg     #你的大头贴，请使用绝对地址.
```
...
![](http://www.francissoung.com/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://www.francissoung.com/js-module-7day/"
---
```
...
ga_domain: www.francissoung.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/FrancisSoung/francissoung.github.io/issues) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Francis Soung”** 但是我想要在搜索的时候显示 **“Francis Soung | Blog”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。

## 致谢

这个模板是从这里[Huxpro/huxpro.github.io](https://github.com/Huxpro/huxpro.github.io)  fork 的。 感谢Hux!
